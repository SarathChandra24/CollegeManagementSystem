...
<table>
    <tr>
<th><input type="text" name="ThSl1" value=<?php  echo $objPHPExcel->getActiveSheet()->getCell('A14')->getValue(); ?>></th>
<th><input type="text" name="ThSl1F" value= <?php  echo $objPHPExcel->getActiveSheet()->getCell('B14')->getValue(); ?>></th>
<th><input type="text" name="ThSl1R" value= <?php  echo $objPHPExcel->getActiveSheet()->getCell('C14')->getValue(); ?> ></th>
<th><input type="text" name="ThSl1" value=<?php  echo $objPHPExcel->getActiveSheet()->getCell('D14')->getValue(); ?>></th>
<th><input type="text" name="ThSl1F" value= <?php  echo $objPHPExcel->getActiveSheet()->getCell('E14')->getValue(); ?>></th>
<th><input type="text" name="ThSl1R" value= <?php  echo $objPHPExcel->getActiveSheet()->getCell('F14')->getValue(); ?> ></th>
<th><input type="text" name="ThSl1F" value= <?php  echo $objPHPExcel->getActiveSheet()->getCell('G14')->getValue(); ?>></th>
<th><input type="text" name="ThSl1R" value= <?php  echo $objPHPExcel->getActiveSheet()->getCell('H14')->getValue(); ?> ></th>
</tr>
</table>
    </section>

...
<!-- SQL query goes here -->
<?php 
$strSQL = "SELECT sid, firstname, lastname, father_name, mother_name, gender, guardian_email, s_mob_no, city, batch, branch, state, blood_group FROM student WHERE sid = '".$id."'";
...
<label class="control-label" for="stuinfo-stu_address">Address</label><textarea  id="stuinfo-stu_address" class="form-control" cols="2" name="address"  readonly><?php echo $address; ?></textarea><div class="help-block"></div>
</div>    
</div>
<div class="col-xs-12 col-sm-4 col-lg-4">

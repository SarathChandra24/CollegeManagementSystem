...
<div class="box box-default">
	<div class="box-header with-border">
		<h3 class="box-title"><i class="fa fa-graduation-cap"></i> TimeTable</h3>
	</div>
	<div class="box-body">
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
		      <div class="edusec-link-box">
		        ...
		        <div class="edusec-link-box-content">
		          <span class="edusec-link-box-text"><a href="Stimetable.php">College TimeTable</a></span>
...
<div class="col-md-4 col-sm-6 col-xs-12">
              <div class="edusec-link-box">
                ...
                <div class="edusec-link-box-content">
                  <span class="edusec-link-box-text"><a href="Stranspotationtimetable.php">Bus TimeTable</a></span>
                 </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
        </div>

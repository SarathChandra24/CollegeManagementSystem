    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid" id="test">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="home.php">WALL-E</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                if(isset($_SESSION["userid"]) && isset($_SESSION["password"]) && isset($_SESSION["userType"]) || isset($_COOKIE["id"]) && isset($_COOKIE["password"]) && isset($_COOKIE["userType"])) {
                 ...
                 ?>
                    <li>
                        <a href="results.jbrec.online" target="_blank">Results</a>
                    </li>
                    <li>
                        <a href="materials.jbrec.online" target="_blank">Materials</a>
                    </li>
                    <li>
                        <a href="http://www.jbrec.edu.in" target="_blank">Visit Our Website</a>
                    </li>
                    ...
                    <!--          Modal Body And  Main Form Container-->
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                ...
                                <label>In case you forgot password contact <a href="mailto:admin@jbrec.edu.in">admin</a></label>

...
<script src="js/bootbox.js"></script><script src="js/home_js.js"></script>
...
<a class="logo" href="home.php"><!--imsg src="img/edusec.png" alt="" height="22px" width="120px;"--><h3>WALL-E</h3></a>
...
$status="Active";
$strSQL = "SELECT * FROM notification WHERE usr_typ = '".$user."' AND status='".$status."' ";
    $rs = mysqli_query($strSQL);
        ...
        $notification_list = "";
         ...
         ?>
        <li class="header"><a id="note" onclick=sendInfo(<?php echo $row['note_id']  ?>) href=<?php echo $row['app']; ?> ><?php echo $row['note'];  ?></a></li>

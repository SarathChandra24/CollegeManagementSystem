...
<li><a href="index.php?controller=student&action=sem_module"><i class="fa fa-user-secret"></i> <span>Hostel</span></a></li>-->

<li><a href="SemModule.php"><i class="fa fa-user-secret"></i> <span>Semester Marks</span></a></li>
<li><a href="AttendanceModule.php"><i class="fa fa-user-secret"></i> <span>Attendance</span></a></li>

...
<label class="control-label" for="stuinfo-stu_address">Father Occupation</label><input type="address" id="address" class="form-control" name="address"><div class="help-block"></div>
</div>    
</div>
   </div>
...
<label class="control-label" for="stuinfo-stu_city">Address</label><input type="address" id="city" class="form-control" name="city"><div class="help-block"></div>
</div>    </div>
...
<option value="OP">O+</option>
   ...
   <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_state required">
<label class="control-label" for="stuinfo-stu_state">Student Email</label><input type="text" id="smail" class="form-control" name="smail"><div class="help-block"></div>
</div>    </div>
...
<label class="control-label" for="stuinfo-stu_jee_rank">% of SSC Marks</label><input type="text" id="jee_rank" class="form-control" name="jee_rank"><div class="help-block"></div>
</div>    </div>
   
 <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_jee_roll_no required">
<label class="control-label" for="stuinfo-stu_jee_roll_no">% of Inter Marks with Medium</label><input type="number" id="jee_roll_no" class="form-control" name="jee_roll_no"><div class="help-block"></div>
</div>    </div>
   
 <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_board required">
<label class="control-label" for="stuinfo-stu_board">EAMCET RANK</label><input type="text" id="board" class="form-control" name="board"><div class="help-block"></div>
</div>    </div>
  <div class="col-xs-12 col-sm-12 col-lg-12 no-padding">
     <div class="col-xs-12 col-sm-4 col-lg-4">
...
<label class="control-label" for="stuinfo-stu_branch">Academic Years</label><select id="batch" class="form-control" name="batch">
<option value="">---Branch---</option>
<option value="2016-20">2016-20(B.Tech)</option>
<option value="2017-21">2017-21(B.Tech)</option>
<option value="2018-22">2018-22(B.Tech)</option>
<option value="2019-23">2019-23(B.Tech)</option>
<option value="2018-20">2018-20(M.Tech,MBA)</option>
<option value="2019-21">2019-21(M.Tech,MBA)</option>
</select><div class="help-block"></div>
</div>    </div>
 ...
 <div class="col-xs-12 col-sm-12 col-lg-12 no-padding">
     <div class="col-xs-12 col-sm-4 col-lg-4">
  <div class="form-group field-stuinfo-stu_branch">
<label class="control-label" for="stuinfo-stu_branch">Admission Type</label><select id="mc" class="form-control" name="mc">
<option value="">---Status---</option>
<option value="1">Convener</option>

...
<!--button><a href='logout.php'>Logout</a></button-->
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="uploadattendance.php"><i class="fa fa-graduation-cap"></i> <span>Attendance Upload</span></a></li>
		    <!--<li><a href="FacTimeTable.php"><i class="fa fa-money"></i> <span>Time Table</span></a></li>-->
            <li><a href="faculty_materials.php"><i class="fa fa-money"></i> <span>Upload Materials</span></a></li>
            </ul>

...
<div class="box-header with-border">
  <div class="row">
    ...
    <h3 class="box-title"><ul class="nav nav-pills">
    <li class="active"><a data-toggle="pill" href="#home"><i class="fas fa-laptop-code"></i>I-I</a></li>
    <li><a data-toggle="pill" href="#menu1"><i class=""></i>I-II</a></li>
    <li><a data-toggle="pill" href="#menu2"><i class=""></i>II-I</a></li>
    <li><a data-toggle="pill" href="#menu3"><i class=""></i>II-II</a></li>
    <li><a data-toggle="pill" href="#menu4"><i class=""></i>III-I</a></li>
    <li><a data-toggle="pill" href="#menu5"><i class=""></i>III-II</a></li>
    <li><a data-toggle="pill" href="#menu6"><i class=""></i>IV-I</a></li>
    <li><a data-toggle="pill" href="#menu7"><i class=""></i>IV-II</a></li>
  </ul></h3>
  </div>
  <div class="box-body">
    <div id="home" class="tab-pane fade in active">
      <?php include_once("semone.php");?>
    </div>
    <div id="menu1" class="tab-pane fade">
      <?php include_once("semtwo.php");?>
    </div>
    <div id="menu2" class="tab-pane fade">
      <?php include_once("semthree.php");?>
    </div>
    <div id="menu3" class="tab-pane fade">
      <?php include_once("semfour.php");?>
    </div>
    <div id="menu4" class="tab-pane fade">
      <?php include_once("semfive.php");?>
    </div>
    <div id="menu5" class="tab-pane fade">
      <?php include_once("semsix.php");?>
    </div>
    <div id="menu6" class="tab-pane fade">
      <?php include_once("semseven.php");?>
    </div>
    <div id="menu7" class="tab-pane fade">
      <?php include_once("semeight.php");?>
    </div>
  </div>
</div>
</div>

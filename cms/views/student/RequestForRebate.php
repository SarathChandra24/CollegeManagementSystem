...
<li><a href="?controller=student&action=mess_module">Mess</a></li>
<li><a href="?controller=student&action=reqforrebate">Request for Rebate</a></li>
<li class="active">Rebate Form</li>
</ul>

    <section class="content">
        <div class="col-xs-12">
  <div class="col-lg-4 col-sm-4 col-xs-12 no-padding"><h3 class="box-title"><i class="fa fa-plus"></i> Rebate form</h3></div>
...
<label class="control-label" for="stuinfo-stu_start_date">Starting Date of rebate</label>
...
<label class="control-label" for="stuinfo-stu_problem_subject">No of Days for Rebate</label>
...
<textarea id="msgofday-msg_details" class="form-control" name="description" maxlength="100" required placeholder="Enter discription of complain"></textarea>
